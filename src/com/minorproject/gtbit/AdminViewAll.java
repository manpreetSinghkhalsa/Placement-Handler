...
class AdminViewAll extends JPanel
{
	/**
	 * 
	 */
	...
	DefaultTableModel getTableModel()
	{
		...
		String columns[] = {"SNO.","Name", "UserName","Designation", "Email"};
	...
	static void getJTableonFrame()
	{
		...
		MainFrame.mainContent.add(new AdminViewAll(),
